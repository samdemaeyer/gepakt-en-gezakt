  ...
  return (
    <div id={id} className="scroll-section">
        ...
        <div className="d-flex container">
          <div className="content mt-3">
            ...
            <p className="text-justify text-sm-left">
              ...
              op en op deze manier maak jij ook jouw statement duidelijk tegenover de plooiers.
            </p>
          </div>
          <div className="content mt-3">
            <h3 className="mb-1">Miszaksel</h3>
            <p className="text-justify text-sm-left">
              Onze ‘miszaksel’ (niet te verwarren met ‘misbaksel’), is zowel een handige als stijlvolle tas.
              Tegenwoordig worden er veel ‘tote bags’ uitgedeeld die erg functioneel zijn. Het enige minpunt aan de
              traditionele ‘tote bags’, is dat deze nooit waterdicht zijn, wat in België toch wel handig kan zijn.
              Daarom hebben we ons ‘miszaksel’ zo gemaakt dat deze handige ‘tote bag’, welke bestaat uit gerecycleerde
              materialen, eveneens waterdicht is.
            </p>
          </div>
          <div className="content mt-3">
            <h3 className="mb-1">Frakzak</h3>
            <p className="text-justify text-sm-left">
              De ‘Frakzak’ is niet voor niets de beste frak! Gemaakt van oude festivaltentjes en in een handig
              formaat. Je komt nooit meer op een festival zonder een herbruikbare poncho die nog eens stijlvol is ook!
              Makkelijk op te bergen en mee te nemen in een zakje. Wie lokt gij mee in uw tent?
            </p>
          </div>
        </div>
      </section>
      <section className="bg-light p-3 mx-5 center-block">
        ...
        <p>Ben jij overtuigd?! en wil jij er eentje?</p>
        <p>
          Klik dan{' '}
